...
def predict(request):
    ...
    model = pd.read_pickle('./salary_prediction/DR_model.pickle')
    edu_enc = pd.read_pickle('./salary_prediction/edu_enc.pickle')
    gen_enc = pd.read_pickle('./salary_prediction/gen_enc.pickle')
    job_enc = pd.read_pickle('./salary_prediction/job_enc.pickle')
